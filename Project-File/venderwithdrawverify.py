...
<body>
 ...
 <a href="venderwithdrawverify.py" class="w3-bar-item w3-button">Vender Withdraw Verify</a>    
...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
  ...
  <div class="w3-display-container w3-center">
    <img src="images/sec4.jpg" style="height:600px","width:100%">
    <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
       <h1>Welcome to securing Card transaction</h1>
        <p>Welcome To PUF Home...
		</p>   
    </div>
  </div>
  </div><br><br> 
...
print("""
    ...
    <div id="footer">
      <center><p><a href="pufhome.html">Home</a> | <a href="venderwithdrawverify.py">Vender Withdraw Verify</a> | <a href="shravya.html">Logout</a></p>
