...
<body>
 ...
 <a href="binarykey.py" class="w3-bar-item w3-button">Binary Key</a>    
...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
  ...
  <div class="w3-display-container w3-center">
    <img src="images/credit3.jpg" style="height:600px","width:100%">
...
print("""
    ...
    <div id="footer">
      <center><p><a href="adminhome.html">Home</a> | <a href="binarykey.py">Binary Key</a> | <a href="shravya.html">Logout</a></p>
