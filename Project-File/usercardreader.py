...
<body>
 ...
 <a href="usercardreader.py" class="w3-bar-item w3-button">User Card Reader</a>    
...
print("""
    ...
    <div id="footer">
      <center><p><a href="pufhome.html">Home</a> | <a href="usercardreader.py">User Card Reader</a> | <a href="shravya.html">Logout</a></p>
